...
public class RequestListener extends FirebaseInstanceIdService implements Runnable{
    User user;
    Activity baseActivity;
    SendFCMTokenService sendFCMTokenService;

    public RequestListener() {
        this.user = ApplicationUtil.getInstance().getUser();
        baseActivity = null;
        sendFCMTokenService = new SendFCMTokenService();
    }
    ...
    public void onTokenRefresh() {
        ...
        Log.d("AH", "Refreshed token: " + refreshedToken);
