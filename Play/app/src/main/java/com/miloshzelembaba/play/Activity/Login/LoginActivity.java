package com.miloshzelembaba.play.Activity.Login;
...
public class LoginActivity extends Activity {
    public static final int LOGIN_ACTIVITY_USER_RESULT = 1;
...
//        }
    ...
    private void finishAndReturn(User user) {
        Intent intent = new Intent();
        try {
            intent.putExtra("user", user.serialize().toString());
        } catch (Exception e){
            intent.putExtra("user", "");
        }
        setResult(LOGIN_ACTIVITY_USER_RESULT, intent);
        finish();
    }
