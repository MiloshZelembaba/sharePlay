...
public class AttemptLoginService {
    ...
    public interface AttemptLoginServiceCallback{
        void onSuccess(JSONObject response);
        void onFailure(String errorMessage);
    }


    public void requestService(String email, String product, final AttemptLoginServiceCallback callback){
        apiService = new APIRequest();
        Request request = new Request();
        request.setUrl("attemptLogin/");
